...
public class Alarm {
    ...
    public Alarm() {
    	...
    	this.sleepingThreads = new TreeMap<long, KThread> TreeMap();
	    });
    }
	...
	long currentTime = Machine.time().getTime();
	while (!sleepingThread.isEmpty() && this.sleepingThreads.firstKey() <= currentTime)
